...
namespace DelightFoods_Live.Controllers
{
    public class CategoryController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,CreatedByUTC")] CategoryModel categoryModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,CreatedByUTC")] CategoryModel categoryModel)
        {
